...
def upgrade() -> None:
    ...
    op.create_table('members',
        ...
        sa.Column('student_id', sa.String(length=20), nullable=False, comment='学号/员工号（纯数字，必填）'),
        ...
        sa.Column('role', sa.Enum('ADMIN', 'GROUP_LEADER', 'MEMBER', 'GUEST', name='userrole'), nullable=False, comment='用户角色'),
