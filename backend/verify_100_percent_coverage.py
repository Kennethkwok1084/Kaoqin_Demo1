...
class CoverageAnalyzer:
    ...
    def discover_api_endpoints(self) -> Set[str]:
        ...
        known_endpoints = [
            ...
            "PUT /api/v1/auth/change-password", "POST /api/v1/auth/verify-token",
            
            "GET /api/v1/members/", "POST /api/v1/members/",
            "GET /api/v1/members/{id}", "PUT /api/v1/members/{id}", 
            "DELETE /api/v1/members/{id}",
            "GET /api/v1/members/health", "GET /api/v1/members/search",
            "POST /api/v1/members/bulk-operations",
            "PUT /api/v1/members/{id}/roles", "GET /api/v1/members/{id}/permissions",
            "GET /api/v1/members/{id}/activity-log", "GET /api/v1/members/{id}/statistics",
            "GET /api/v1/members/{id}/performance", "POST /api/v1/members/{id}/complete-profile",
            "PUT /api/v1/members/{id}/teams", "POST /api/v1/members/export",
            
            "GET /api/v1/tasks/", "GET /api/v1/tasks/status",
            "GET /api/v1/tasks/repair-list", "POST /api/v1/tasks/repair",
            "GET /api/v1/tasks/repair/{id}", "PUT /api/v1/tasks/repair/{id}",
            "DELETE /api/v1/tasks/repair/{id}", "DELETE /api/v1/tasks/batch-delete",
            "POST /api/v1/tasks/{id}/start", "POST /api/v1/tasks/{id}/complete",
            "POST /api/v1/tasks/{id}/cancel", "GET /api/v1/tasks/my",
            "GET /api/v1/tasks/stats", "GET /api/v1/tasks/tags",
            "POST /api/v1/tasks/tags", "GET /api/v1/tasks/monitoring",
            "GET /api/v1/tasks/assistance", "GET /api/v1/tasks/work-time-detail/{id}",
            ...
            "GET /api/v1/statistics/overview", "GET /api/v1/statistics/efficiency",
            "GET /api/v1/statistics/monthly-report", "GET /api/v1/statistics/charts",
            "GET /api/v1/statistics/rankings", "GET /api/v1/statistics/attendance",
            "GET /api/v1/statistics/work-hours/analysis",
            "GET /api/v1/statistics/work-hours/trend",
            "POST /api/v1/statistics/export", "GET /api/v1/statistics/work-hours/overview",
            
            "GET /api/v1/dashboard/overview", "GET /api/v1/dashboard/my-tasks",
            "GET /api/v1/dashboard/recent-activities", "GET /api/v1/dashboard/notifications",
            "GET /api/v1/dashboard/quick-actions",
            
            "POST /api/v1/attendance/export", "GET /api/v1/attendance/export-preview",
            "GET /api/v1/attendance/chart-data", "GET /api/v1/attendance/stats",
            "POST /api/v1/attendance/records", "PUT /api/v1/attendance/records/{id}",
            
            "GET /api/v1/import/field-mapping", "POST /api/v1/import/preview",
            "POST /api/v1/import/execute", "GET /api/v1/import/history",
            
            "GET /api/v1/system-config/settings", "PUT /api/v1/system-config/settings",
            "GET /api/v1/system-config/user-preferences",
            "PUT /api/v1/system-config/user-preferences",
            "GET /api/v1/system-config/status", "POST /api/v1/system-config/backup",
            "POST /api/v1/system-config/restore", "POST /api/v1/system-config/maintenance",
            "GET /api/v1/system-config/logs", "POST /api/v1/system-config/clear-cache",
        ]
    ...
    def analyze_test_coverage(self, test_files: List[Path]) -> Dict[str, Any]:
        ...
        for test_file in test_files:
            try:
                ...
                coverage_info["test_categories"][category]["functions"] += len(test_functions)
    ...
    def calculate_coverage_percentage(self, total_endpoints: int, covered_endpoints: int) -> float:
        """计算覆盖率百分比"""
    ...
    def generate_report(self) -> Dict[str, Any]:
        ...
        coverage_percentage = self.calculate_coverage_percentage(total_count, covered_count)
        ...
        report = {
            ...
            "uncovered_endpoints": list(self.api_endpoints - self.test_coverage["covered_endpoints"]),
    ...
    def _generate_recommendations(self, coverage_percentage: float) -> List[str]:
        ...
        if coverage_percentage < 100:
            recommendations.append(f"当前覆盖率 {coverage_percentage:.1f}%，需要补充缺失端点的测试")
