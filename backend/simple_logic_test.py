...
def test_work_hours_logic():
    ...
    def calculate_normal_hours(base_minutes: int, bonuses: list, penalties: list) -> int:
...
def main():
    ...
    try:
        ...
        print("=" * 50)
        print("🎉 All logic tests passed! The refactored algorithms are working correctly.")
        print()
