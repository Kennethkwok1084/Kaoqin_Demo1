...
class Messages:
    ...
    AUTH_ERROR_UNAUTHORIZED_UPDATE = "无权限修改 {field} 字段"
...
class MessageManager:
    ...
    def get_message(self, message_key: str, **format_kwargs) -> str:
        """
        获取格式化后的消息
...
def success_response(message_key: str, data: Any = None, **kwargs) -> Dict[str, Any]:
    """创建成功响应"""
...
def warning_response(message_key: str, data: Any = None, **kwargs) -> Dict[str, Any]:
    """创建警告响应"""
    return message_manager.create_warning_response(message_key, data, **kwargs)

def info_response(message_key: str, data: Any = None, **kwargs) -> Dict[str, Any]:
    """创建信息响应"""
    return message_manager.create_info_response(message_key, data, **kwargs)