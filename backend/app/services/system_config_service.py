...
class SystemConfigService:
    ...
    DEFAULT_CONFIGS: List[Dict[str, Any]] = [
        ...
        # 任务流程配置（兼容路由/正式路由共用）
        {
            "config_key": "checkin_qrcode_refresh_seconds",
            "config_name": "签到二维码刷新秒数",
            "config_description": "协助任务签到二维码有效期（秒）",
            "category": "thresholds",
            "config_group": "任务流程",
            "value_type": "integer",
            "default_value": "60",
        ...
        {
            "config_key": "task_qrcode_refresh_seconds",
            "config_name": "任务二维码刷新秒数",
            "config_description": "任务二维码刷新秒数（兼容键）",
            "category": "thresholds",
            "config_group": "任务流程",
            "value_type": "integer",
            "default_value": "60",
        ...
        {
            "config_key": "qrcode_refresh_seconds",
            "config_name": "二维码刷新秒数",
            "config_description": "通用二维码刷新秒数（兜底键）",
            "category": "thresholds",
            "config_group": "任务流程",
            "value_type": "integer",
            "default_value": "60",
        ...
        {
            "config_key": "network_loss_threshold_pct",
            "config_name": "网络丢包率阈值",
            "config_description": "网络检测自动异常判定的丢包率阈值（%）",
            "category": "thresholds",
            "config_group": "网络检测",
            "value_type": "float",
            "default_value": "5.0",
        ...
        {
            "config_key": "sampling_network_loss_threshold_pct",
            "config_name": "抽检丢包率阈值",
            "config_description": "抽检场景网络丢包率阈值（%）",
            "category": "thresholds",
            "config_group": "网络检测",
            "value_type": "float",
            "default_value": "5.0",
        ...
        {
            "config_key": "network_tcp_rtt_threshold_ms",
            "config_name": "网络TCP时延阈值",
            "config_description": "网络检测自动异常判定的TCP时延阈值（ms）",
            "category": "thresholds",
            "config_group": "网络检测",
            "value_type": "float",
            "default_value": "200.0",
        ...
        {
            "config_key": "sampling_network_tcp_rtt_threshold_ms",
            "config_name": "抽检TCP时延阈值",
            "config_description": "抽检场景TCP时延阈值（ms）",
            "category": "thresholds",
            "config_group": "网络检测",
            "value_type": "float",
            "default_value": "200.0",
        ...
        {
            "config_key": "network_down_speed_min_mbps",
            "config_name": "下行速率最小阈值",
            "config_description": "网络检测自动异常判定的下行速率阈值（Mbps）",
            "category": "thresholds",
            "config_group": "网络检测",
            "value_type": "float",
            "default_value": "20.0",
        ...
        {
            "config_key": "sampling_network_down_speed_min_mbps",
            "config_name": "抽检下行速率最小阈值",
            "config_description": "抽检场景下行速率阈值（Mbps）",
            "category": "thresholds",
            "config_group": "网络检测",
            "value_type": "float",
            "default_value": "20.0",
        ...
        {
            "config_key": "network_up_speed_min_mbps",
            "config_name": "上行速率最小阈值",
            "config_description": "网络检测自动异常判定的上行速率阈值（Mbps）",
            "category": "thresholds",
            "config_group": "网络检测",
            "value_type": "float",
            "default_value": "2.0",
        ...
        {
            "config_key": "sampling_network_up_speed_min_mbps",
            "config_name": "抽检上行速率最小阈值",
            "config_description": "抽检场景上行速率阈值（Mbps）",
            "category": "thresholds",
            "config_group": "网络检测",
            "value_type": "float",
            "default_value": "2.0",
        ...
        {
            "config_key": "network_abnormal_default_note",
            "config_name": "异常标记默认备注",
            "config_description": "管理员手工标记网络异常时的默认备注",
            "category": "general",
            "config_group": "网络检测",
            "value_type": "string",
            "default_value": "marked_by_admin",
            "display_order": 112,
            "is_system_config": True,
            "required_role": "admin",
        },
        {
            "config_key": "workhour_rule_default_biz_type",
            "config_name": "工时规则默认业务类型",
            "config_description": "创建工时规则时默认业务类型",
            "category": "work_hours",
            "config_group": "工时规则",
            "value_type": "string",
        ...
        {
            "config_key": "workhour_rule_default_formula_desc",
            "config_name": "工时规则默认公式描述",
            "config_description": "创建工时规则时默认公式描述",
            "category": "work_hours",
            "config_group": "工时规则",
            "value_type": "string",
            "default_value": "",
        ...
        {
            "config_key": "workhour_rule_default_enabled",
            "config_name": "工时规则默认启用",
            "config_description": "创建工时规则时是否默认启用（1/0）",
            "category": "work_hours",
            "config_group": "工时规则",
            "value_type": "integer",
            "default_value": "1",
        ...
        {
            "config_key": "manual_workhour_default_biz_type",
            "config_name": "手工工时默认业务类型",
            "config_description": "手工补录工时默认业务类型",
            "category": "work_hours",
            "config_group": "手工补录",
            "value_type": "string",
            "default_value": "repair",
        ...
        {
            "config_key": "manual_workhour_default_base_minutes",
            "config_name": "手工工时默认基础分钟",
            "config_description": "手工补录工时默认基础分钟数",
            "category": "work_hours",
            "config_group": "手工补录",
            "value_type": "integer",
            "default_value": "0",
        ...
        {
            "config_key": "manual_workhour_default_final_minutes",
            "config_name": "手工工时默认最终分钟",
            "config_description": "手工补录工时默认最终分钟数",
            "category": "work_hours",
            "config_group": "手工补录",
            "value_type": "integer",
            "default_value": "0",
        ...
        {
            "config_key": "manual_workhour_max_minutes",
            "config_name": "手工工时分钟上限",
            "config_description": "手工补录工时每条记录分钟上限",
            "category": "work_hours",
            "config_group": "手工补录",
            "value_type": "integer",
            "default_value": "720",
        ...
        {
            "config_key": "manual_workhour_default_note",
            "config_name": "手工工时默认备注",
            "config_description": "手工补录工时默认审核备注",
            "category": "work_hours",
            "config_group": "手工补录",
            "value_type": "string",
        ...
        {
            "config_key": "checkin_location_radius_meters",
            "config_name": "签到定位半径(米)",
            "config_description": "签到/签退允许的楼栋定位半径(米)",
            "category": "thresholds",
            "config_group": "任务流程",
            "value_type": "integer",
            "default_value": "200",
        ...
        {
            "config_key": "checkin_signout_max_distance_meters",
            "config_name": "签到签退最大偏移(米)",
            "config_description": "签到与签退位置允许的最大偏移距离(米)",
            "category": "thresholds",
            "config_group": "任务流程",
            "value_type": "integer",
            "default_value": "500",
        ...
        {
            "config_key": "checkin_device_consistency_required",
            "config_name": "签到设备一致性校验",
            "config_description": "是否启用签到签退设备一致性校验(1/0)",
            "category": "general",
            "config_group": "任务流程",
            "value_type": "integer",
            "default_value": "1",
        ...
        {
            "config_key": "checkin_qr_allow_legacy_token",
            "config_name": "允许旧版二维码令牌",
            "config_description": "二维码验签时是否允许旧版无签名token(1/0)",
            "category": "general",
            "config_group": "任务流程",
            "value_type": "integer",
            "default_value": "1",
