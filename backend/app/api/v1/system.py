    ...
    try:
        ...
        for config in configs:
            ...
            if config_key.startswith("work_hours."):
                ...
                if key in ["onlinetaskminutes", "offlinetaskminutes", "rushbonusminutes", 
                          "positivereviewbonusminutes", "lateresponsepenaltyminutes",
                          "latecompletionpenaltyminutes", "negativereviewpenaltyminutes"]:
...
async def update_system_settings(
    ...
    try:
        ...
        logger.info(f"System settings updated by user {current_user.id}: {config_updates}")
