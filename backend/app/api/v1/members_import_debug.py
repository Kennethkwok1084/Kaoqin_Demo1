...
from app.api.deps import (
    get_db, get_current_user, get_current_active_user, get_current_active_admin, 
    ...
    try:
        ...
        for index, member_data in enumerate(import_data.members):
            try:
                ...
                logger.info(f"Creating member {index + 1}: {name_safe} ({student_id_safe})")
                ...
                logger.info(f"Member {index + 1} created successfully with ID {new_member.id}")
