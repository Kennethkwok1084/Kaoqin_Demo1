    ...
    try:
        ...
        if files:
            ...
            for module in modules:
                ...
                print(
                    f"{color}{module['name']:<20} {module['coverage']:6.2f}%  ({module['covered']:3d}/{module['statements']:3d}) {status}\033[0m"
                )
        ...
        for module_name, data in before_after.items():
            ...
            print(
                f"📈 {module_name:<15} {data['before']:6.2f}% → {data['after']:6.2f}% (+{improvement:5.2f}%)"
            )
        ...
        print(f"\n🧪 测试用例统计:")
        print("-" * 60)
        test_counts = {"deps.py": 66, "security.py": 77, "database.py": 65}
