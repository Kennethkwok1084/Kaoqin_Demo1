...
**基础依赖验证**: 100.0% 通过率
**验证时间**: 2025-07-30T17:31:27.578490
**测试数量**: 6项
**成功数量**: 6项
...
- ✓ python -m pytest D:\Documents\WindSurf\Kaoqin_demo\backend\temp_test.py -v
