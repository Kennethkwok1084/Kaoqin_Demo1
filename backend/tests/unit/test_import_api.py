...
class TestImportAPI:
    ...
    async def test_get_field_mapping_comprehensive_response(self):
        ...
        required_keys = [
            "table_type", "fields", "field_types", "required_fields",
            "optional_fields", "mapping_rules", "validation_rules", 
            "import_examples", "data_processing_rules"
        ]
