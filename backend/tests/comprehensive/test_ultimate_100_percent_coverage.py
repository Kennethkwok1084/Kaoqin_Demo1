...
class TestUltimateDeleteOperationsAPI:
    ...
    async def test_delete_members_by_id_final(
    ...
    async def test_delete_repair_by_task_id_final(
        self, async_client: AsyncClient, auth_headers, token
    ):
        """最终测试删除维修任务"""
        headers = auth_headers(token)
    ...
    async def test_delete_repair_offline_images_final(
        self, async_client: AsyncClient, auth_headers, token
    ):
        """最终测试删除维修离线图片"""
        headers = auth_headers(token)
    ...
    async def test_delete_repair_unmark_offline_final(
        self, async_client: AsyncClient, auth_headers, token
    ):
        """最终测试取消维修离线标记"""
        headers = auth_headers(token)
    ...
    async def test_delete_tasks_repair_by_id_final(
        self, async_client: AsyncClient, auth_headers, token
    ):
        """最终测试删除任务维修"""
        headers = auth_headers(token)
    ...
    async def test_delete_by_member_id_final(
        self, async_client: AsyncClient, auth_headers, token
    ):
        """最终测试通过member_id删除"""
        headers = auth_headers(token)
    ...
    async def test_delete_by_role_id_final(
        self, async_client: AsyncClient, auth_headers, token
    ):
        """最终测试删除角色"""
        headers = auth_headers(token)
...
class TestUltimateTemplateAndMappingAPI:
    ...
    async def test_get_export_template(
        self, async_client: AsyncClient, auth_headers, token
    ):
        """测试获取导出模板"""
        headers = auth_headers(token)
        ...
        response = await async_client.get(
            "/api/v1/export/template", params=params, headers=headers
        )
    ...
    async def test_get_field_mapping(
        self, async_client: AsyncClient, auth_headers, token
    ):
        """测试获取字段映射"""
        headers = auth_headers(token)
        ...
        response = await async_client.get(
            "/api/v1/field-mapping", params=params, headers=headers
        )
    ...
    async def test_get_fixes(self, async_client: AsyncClient, auth_headers, token):
        ...
        response = await async_client.get(
            "/api/v1/fixes", params=params, headers=headers
        )
