...
class TestCoreAuthUserManagementAPI:
    ...
    async def test_put_me(self, async_client: AsyncClient, auth_headers, token):
        ...
        response = await async_client.put("/api/v1/me", 
    ...
    async def test_put_auth_me(self, async_client: AsyncClient, auth_headers, token):
        ...
        response = await async_client.put("/api/v1/auth/me",
                                        json=update_data, headers=headers)
    ...
    async def test_put_auth_change_password(self, async_client: AsyncClient, auth_headers, token):
        """测试修改密码"""
        headers = auth_headers(token)
        password_data = {
        ...
        response = await async_client.put("/api/v1/auth/change-password",
    ...
    async def test_get_verify_token(self, async_client: AsyncClient, auth_headers, token):
        """测试验证token"""
        headers = auth_headers(token)
...
class TestMemberManagementAPI:
    ...
    async def test_get_member_by_id(self, async_client: AsyncClient, auth_headers, token):
        """测试获取指定成员信息"""
        headers = auth_headers(token)
        member_id = 1
    ...
    async def test_put_member_by_id(self, async_client: AsyncClient, auth_headers, token):
        """测试更新指定成员信息"""
        headers = auth_headers(token)
        member_id = 1
        update_data = {
        ...
        response = await async_client.put(f"/api/v1/members/{member_id}",
                                        json=update_data, headers=headers)
    ...
    async def test_delete_member_by_id(self, async_client: AsyncClient, auth_headers, token):
        ...
        response = await async_client.delete(f"/api/v1/members/{member_id}", headers=headers)
    ...
    async def test_get_member_permissions(self, async_client: AsyncClient, auth_headers, token):
        """测试获取成员权限"""
        headers = auth_headers(token)
        member_id = 1
    ...
    async def test_put_member_roles(self, async_client: AsyncClient, auth_headers, token):
        """测试更新成员角色"""
        headers = auth_headers(token)
        member_id = 1
        roles_data = {
        ...
        response = await async_client.put(f"/api/v1/members/{member_id}/roles",
                                        json=roles_data, headers=headers)
    ...
    async def test_get_member_activity_log(self, async_client: AsyncClient, auth_headers, token):
        """测试获取成员活动日志"""
        headers = auth_headers(token)
        member_id = 1
        params = {
    ...
    async def test_get_member_statistics(self, async_client: AsyncClient, auth_headers, token):
        """测试获取成员统计信息"""
        headers = auth_headers(token)
        member_id = 1
        params = {
    ...
    async def test_get_member_performance(self, async_client: AsyncClient, auth_headers, token):
        """测试获取成员绩效报告"""
        headers = auth_headers(token)
        member_id = 1
        params = {
    ...
    async def test_put_member_teams(self, async_client: AsyncClient, auth_headers, token):
        """测试更新成员团队分配"""
        headers = auth_headers(token)
        member_id = 1
        teams_data = {
    ...
    async def test_post_member_complete_profile(self, async_client: AsyncClient, auth_headers, token):
        """测试完善成员资料"""
        headers = auth_headers(token)
        member_id = 1
        profile_data = {
