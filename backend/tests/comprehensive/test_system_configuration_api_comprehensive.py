...
class TestSystemConfigurationAPI:
    ...
    async def test_get_config(self, async_client: AsyncClient, auth_headers, token):
        ...
        response = await async_client.get(
            "/api/v1/config", params=params, headers=headers
        )
    ...
    async def test_update_config(self, async_client: AsyncClient, auth_headers, token):
        ...
        response = await async_client.put(
            "/api/v1/config", json=config_data, headers=headers
        )
    ...
    async def test_get_settings(self, async_client: AsyncClient, auth_headers, token):
        ...
        response = await async_client.get(
            "/api/v1/settings", params=params, headers=headers
        )
    ...
    async def test_update_settings(
        ...
        response = await async_client.put(
            "/api/v1/settings", json=settings_data, headers=headers
        )
        ...
        if response.status_code in [200, 201]:
            ...
            if "work_start_time" in updated_settings:
                assert (
                    updated_settings["work_start_time"]
...
class TestSystemLogsAndAuditAPI:
    ...
    async def test_get_logs(self, async_client: AsyncClient, auth_headers, token):
        ...
        response = await async_client.get(
            "/api/v1/logs", params=params, headers=headers
        )
    ...
    async def test_get_audit(self, async_client: AsyncClient, auth_headers, token):
        ...
        response = await async_client.get(
            "/api/v1/audit", params=params, headers=headers
        )
    ...
    async def test_get_system_status(
        ...
        response = await async_client.get(
            "/api/v1/system/status", params=params, headers=headers
        )
...
class TestNotificationAndAlertAPI:
    ...
    async def test_get_notifications(
        ...
        response = await async_client.get(
            "/api/v1/notifications", params=params, headers=headers
        )
    ...
    async def test_update_notification_status(
        ...
        status_data = {"status": "read", "read_at": datetime.now().isoformat()}
    ...
    async def test_get_alerts(self, async_client: AsyncClient, auth_headers, token):
        ...
        response = await async_client.get(
            "/api/v1/alerts", params=params, headers=headers
        )
...
class TestSystemConfigValidationAndErrors:
    ...
    async def test_invalid_config_validation(
        ...
        response = await async_client.put(
            "/api/v1/config", json=invalid_config, headers=headers
        )
    ...
    async def test_config_permission_boundaries(
        self, async_client: AsyncClient, auth_headers, token
    ):
        """测试配置权限边界"""
        headers = auth_headers(token)
        ...
        response = await async_client.put(
            "/api/v1/config", json=sensitive_config, headers=headers
        )
    ...
    async def test_large_notification_batch_handling(
        self, async_client: AsyncClient, auth_headers, token
    ):
        """测试大批量通知处理"""
        headers = auth_headers(token)
        ...
        response = await async_client.post(
            "/api/v1/notifications", json=large_notification, headers=headers
        )
    ...
    async def test_log_query_performance_limits(
        self, async_client: AsyncClient, auth_headers, token
    ):
        """测试日志查询性能限制"""
        headers = auth_headers(token)
        ...
        response = await async_client.get(
            "/api/v1/logs", params=large_query_params, headers=headers
        )
