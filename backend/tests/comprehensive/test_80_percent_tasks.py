...
class TestTaskManagementCoreAPI:
    ...
    async def test_get_task_repair_by_id(
        ...
        response = await async_client.get(
            f"/api/v1/tasks/repair/{task_id}", headers=headers
        )
    ...
    async def test_post_task_start_by_id(
        self, async_client: AsyncClient, auth_headers, token
    ):
        """测试开始指定任务"""
        headers = auth_headers(token)
    ...
    async def test_post_task_complete_by_id(
        self, async_client: AsyncClient, auth_headers, token
    ):
        """测试完成指定任务"""
        headers = auth_headers(token)
    ...
    async def test_post_task_cancel_by_id(
        self, async_client: AsyncClient, auth_headers, token
    ):
        """测试取消指定任务"""
        headers = auth_headers(token)
    ...
    async def test_get_task_work_time_detail(
        self, async_client: AsyncClient, auth_headers, token
    ):
        """测试获取任务工时详情"""
        headers = auth_headers(token)
...
class TestRepairManagementAPI:
    ...
    async def test_get_repair_list(
        ...
        """测试获取维修任务列表"""
        headers = auth_headers(token)
        params = {"page": 1, "size": 20, "status": "pending", "priority": "high"}
        response = await async_client.get(
            "/api/v1/repair-list", params=params, headers=headers
        )
    ...
    async def test_get_repair_by_task_id(
        self, async_client: AsyncClient, auth_headers, token
    ):
        """测试获取指定维修任务详情"""
        headers = auth_headers(token)
    ...
    async def test_put_repair_by_task_id(
        self, async_client: AsyncClient, auth_headers, token
    ):
        """测试更新指定维修任务"""
        headers = auth_headers(token)
        ...
        response = await async_client.put(
            f"/api/v1/repair/{task_id}", json=update_data, headers=headers
        )
    ...
    async def test_delete_repair_by_task_id(
        self, async_client: AsyncClient, auth_headers, token
    ):
        """测试删除指定维修任务"""
        headers = auth_headers(token)
    ...
    async def test_post_repair_create(
        self, async_client: AsyncClient, auth_headers, token
    ):
        """测试创建维修任务"""
        headers = auth_headers(token)
        ...
        response = await async_client.post(
            "/api/v1/repair", json=repair_data, headers=headers
        )
...
class TestTaskTagsAndStatsAPI:
    ...
    async def test_post_tags_create(
        self, async_client: AsyncClient, auth_headers, token
    ):
        """测试创建任务标签"""
        headers = auth_headers(token)
    ...
    async def test_get_stats(self, async_client: AsyncClient, auth_headers, token):
        """测试获取任务统计"""
        headers = auth_headers(token)
        params = {"period": "month", "date_from": "2024-12-01", "date_to": "2024-12-31"}
        response = await async_client.get(
            "/api/v1/stats", params=params, headers=headers
        )
...
class TestTaskErrorHandlingAndEdgeCases:
    ...
    async def test_nonexistent_task_handling(
        self, async_client: AsyncClient, auth_headers, token
    ):
        """测试不存在任务的处理"""
        headers = auth_headers(token)
        ...
        response = await async_client.get(
            f"/api/v1/tasks/repair/{nonexistent_id}", headers=headers
        )
    ...
    async def test_invalid_task_data_handling(
        self, async_client: AsyncClient, auth_headers, token
    ):
        """测试无效任务数据的处理"""
        headers = auth_headers(token)
        ...
        response = await async_client.post(
            "/api/v1/repair", json=invalid_data, headers=headers
        )
    ...
    async def test_task_concurrent_operations(
        self, async_client: AsyncClient, auth_headers, token
    ):
        """测试任务并发操作处理"""
        headers = auth_headers(token)
    ...
    async def test_task_permission_boundaries(
        self, async_client: AsyncClient, auth_headers, token
    ):
        """测试任务权限边界"""
        headers = auth_headers(token)
