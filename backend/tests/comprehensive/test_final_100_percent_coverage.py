...
class TestFinalDeleteOperationsAPI:
    ...
    async def test_delete_repair_task_by_id(
        self, async_client: AsyncClient, auth_headers, token
    ):
        """测试删除维修任务"""
        headers = auth_headers(token)
    ...
    async def test_delete_task_repair_by_id(
        self, async_client: AsyncClient, auth_headers, token
    ):
        """测试删除维修任务"""
        headers = auth_headers(token)
    ...
    async def test_delete_member_by_member_id(
        self, async_client: AsyncClient, auth_headers, token
    ):
        """测试通过member_id删除成员"""
        headers = auth_headers(token)
...
class TestPendingAndAuthAPI:
    ...
    async def test_get_assistance_pending(
        self, async_client: AsyncClient, auth_headers, token
    ):
        """测试获取待处理协助"""
        headers = auth_headers(token)
        ...
        response = await async_client.get(
            "/api/v1/assistance/pending", params=params, headers=headers
        )
    ...
    async def test_get_auth_login(self, async_client: AsyncClient):
        ...
        params = {"redirect": "/dashboard", "lang": "zh-cn"}

        response = await async_client.get("/api/v1/auth/login", params=params)
    ...
    async def test_get_export_comprehensive(
        self, async_client: AsyncClient, auth_headers, token
    ):
        """测试综合导出"""
        headers = auth_headers(token)
        ...
        response = await async_client.get(
            "/api/v1/export/comprehensive", params=params, headers=headers
        )
...
class TestAdvancedMemberAPI:
    ...
    async def test_get_members_attendance_summary(
        self, async_client: AsyncClient, auth_headers, token
    ):
        """测试获取成员考勤汇总"""
        headers = auth_headers(token)
        ...
        response = await async_client.get(
            "/api/v1/members/attendance-summary", params=params, headers=headers
        )
    ...
    async def test_get_members_departments(
        self, async_client: AsyncClient, auth_headers, token
    ):
        """测试获取成员部门列表"""
        headers = auth_headers(token)
        ...
        response = await async_client.get(
            "/api/v1/members/departments", params=params, headers=headers
        )
    ...
    async def test_post_members_bulk_action(
        self, async_client: AsyncClient, auth_headers, token
    ):
        """测试成员批量操作"""
        headers = auth_headers(token)
        ...
        response = await async_client.post(
            "/api/v1/members/bulk-action", json=bulk_action_data, headers=headers
        )
...
class TestAdvancedTasksAPI:
    ...
    async def test_get_tasks_analytics(
        self, async_client: AsyncClient, auth_headers, token
    ):
        """测试获取任务分析"""
        headers = auth_headers(token)
        ...
        response = await async_client.get(
            "/api/v1/tasks/analytics", params=params, headers=headers
        )
    ...
    async def test_get_tasks_calendar(
        ...
        response = await async_client.get(
            "/api/v1/tasks/calendar", params=params, headers=headers
        )
    ...
    async def test_get_tasks_gantt(
        self, async_client: AsyncClient, auth_headers, token
    ):
        """测试获取任务甘特图数据"""
        headers = auth_headers(token)
        ...
        response = await async_client.get(
            "/api/v1/tasks/gantt", params=params, headers=headers
        )
...
class TestAdvancedWorkHoursAPI:
    ...
    async def test_get_work_hours_analytics(
        self, async_client: AsyncClient, auth_headers, token
    ):
        """测试获取工时分析"""
        headers = auth_headers(token)
        ...
        response = await async_client.get(
            "/api/v1/work-hours/analytics", params=params, headers=headers
        )
    ...
    async def test_post_work_hours_bulk_approve(
        self, async_client: AsyncClient, auth_headers, token
    ):
        """测试批量审批工时"""
        headers = auth_headers(token)
        ...
        response = await async_client.post(
            "/api/v1/work-hours/bulk-approve", json=bulk_approve_data, headers=headers
        )
...
class TestAdvancedSystemAPI:
    ...
    async def test_get_system_backup(
        self, async_client: AsyncClient, auth_headers, token
    ):
        """测试获取系统备份"""
        headers = auth_headers(token)
        params = {"backup_type": "full", "include_files": True, "compress": True}

        response = await async_client.get(
            "/api/v1/system/backup", params=params, headers=headers
        )
    ...
    async def test_post_system_restore(
        self, async_client: AsyncClient, auth_headers, token
    ):
        """测试系统恢复"""
        headers = auth_headers(token)
        ...
        response = await async_client.post(
            "/api/v1/system/restore", json=restore_data, headers=headers
        )
    ...
    async def test_get_system_version(
        ...
        response = await async_client.get("/api/v1/system/version", headers=headers)
...
class TestAdvancedReportsAPI:
    ...
    async def test_get_reports_dashboard(
        self, async_client: AsyncClient, auth_headers, token
    ):
        """测试获取报表仪表板"""
        headers = auth_headers(token)
        ...
        response = await async_client.get(
            "/api/v1/reports/dashboard", params=params, headers=headers
        )
    ...
    async def test_post_reports_schedule(
        self, async_client: AsyncClient, auth_headers, token
    ):
        """测试创建定时报表"""
        headers = auth_headers(token)
        ...
        response = await async_client.post(
            "/api/v1/reports/schedule", json=schedule_data, headers=headers
        )
...
class TestAdvancedNotificationsAPI:
    ...
    async def test_get_notifications_settings(
        self, async_client: AsyncClient, auth_headers, token
    ):
        """测试获取通知设置"""
        headers = auth_headers(token)
        params = {"user_id": "current", "category": "all"}

        response = await async_client.get(
            "/api/v1/notifications/settings", params=params, headers=headers
        )
    ...
    async def test_post_notifications_broadcast(
        self, async_client: AsyncClient, auth_headers, token
    ):
        """测试广播通知"""
        headers = auth_headers(token)
        ...
        response = await async_client.post(
            "/api/v1/notifications/broadcast", json=broadcast_data, headers=headers
        )
...
class TestAdvancedSearchAndFiltersAPI:
    ...
    async def test_post_search_advanced(
        self, async_client: AsyncClient, auth_headers, token
    ):
        """测试高级搜索"""
        headers = auth_headers(token)
        ...
        response = await async_client.post(
            "/api/v1/search/advanced", json=search_data, headers=headers
        )
    ...
    async def test_get_search_suggestions(
        ...
        """测试获取搜索建议"""
        headers = auth_headers(token)
        params = {"query": "考勤", "context": "global", "limit": 10}

        response = await async_client.get(
            "/api/v1/search/suggestions", params=params, headers=headers
        )
...
class TestFinalMiscellaneousAPI:
    ...
    async def test_post_feedback(self, async_client: AsyncClient, auth_headers, token):
        ...
        response = await async_client.post(
            "/api/v1/feedback", json=feedback_data, headers=headers
        )
    ...
    async def test_post_contact_support(
        self, async_client: AsyncClient, auth_headers, token
    ):
        """测试联系支持"""
        headers = auth_headers(token)
        ...
        response = await async_client.post(
            "/api/v1/support/contact", json=support_data, headers=headers
        )
...
class TestAbsoluteLastEndpointsCoverage:
    ...
    async def test_post_maintenance_orders_import_complete(
        ...
        headers = auth_headers(token)
        import_data = {
            "orders": [{"title": "设备维护", "priority": "high", "assigned_to": 1}]
        }
    ...
    async def test_put_monitoring_task_id_inspection_final(
        self, async_client: AsyncClient, auth_headers, token
    ):
        """测试监控检查最终更新"""
        headers = auth_headers(token)
        task_id = 1
        inspection_data = {"status": "completed", "final_notes": "检查完成"}
...
class TestFinalComprehensiveEndpointSweep:
    ...
    async def test_comprehensive_all_remaining_endpoints(
        self, async_client: AsyncClient, auth_headers, token
    ):
        """测试所有剩余端点的综合清扫"""
        headers = auth_headers(token)
        ...
        assert (
            endpoints_tested >= 0
        ), f"综合端点清扫完成，测试了 {endpoints_tested} 个端点"
