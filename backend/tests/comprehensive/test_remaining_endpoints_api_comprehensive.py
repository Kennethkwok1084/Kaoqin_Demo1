...
class TestRemainingDeleteOperationsAPI:
    ...
    async def test_batch_delete(self, async_client: AsyncClient, auth_headers, token):
        ...
        response = await async_client.delete("/api/v1/batch-delete",
...
class TestAssistanceAndListAPI:
    ...
    async def test_get_assistance(self, async_client: AsyncClient, auth_headers, token):
        ...
        response = await async_client.get("/api/v1/assistance",
    ...
    async def test_get_assistance_list(self, async_client: AsyncClient, auth_headers, token):
        """测试获取协助列表"""
        headers = auth_headers(token)
        params = {
            "category": "all",
        ...
        response = await async_client.get("/api/v1/assistance/list",
                                        params=params, headers=headers)
    ...
    async def test_get_attendance_leave_types(self, async_client: AsyncClient, auth_headers, token):
        """测试获取请假类型"""
        headers = auth_headers(token)
        params = {
        ...
        response = await async_client.get("/api/v1/attendance/leave-types",
                                        params=params, headers=headers)
...
class TestAdvancedAttendanceAPI:
    ...
    async def test_get_attendance_approvals(self, async_client: AsyncClient, auth_headers, token):
        """测试获取考勤审批"""
        headers = auth_headers(token)
        params = {
            "status": "pending",
        ...
        response = await async_client.get("/api/v1/attendance/approvals",
                                        params=params, headers=headers)
    ...
    async def test_post_attendance_approval(self, async_client: AsyncClient, auth_headers, token):
        """测试提交考勤审批"""
        headers = auth_headers(token)
        approval_data = {
            "attendance_id": 1,
        ...
        response = await async_client.post("/api/v1/attendance/approvals",
    ...
    async def test_get_attendance_summary_stats(self, async_client: AsyncClient, auth_headers, token):
        """测试获取考勤汇总统计"""
        headers = auth_headers(token)
        params = {
            "period": "monthly",
        ...
        response = await async_client.get("/api/v1/attendance/summary-stats",
                                        params=params, headers=headers)
...
class TestAdvancedTaskAPI:
    ...
    async def test_get_task_templates(self, async_client: AsyncClient, auth_headers, token):
        """测试获取任务模板"""
        headers = auth_headers(token)
        params = {
            "category": "all",
        ...
        response = await async_client.get("/api/v1/tasks/templates",
                                        params=params, headers=headers)
    ...
    async def test_post_task_template(self, async_client: AsyncClient, auth_headers, token):
        """测试创建任务模板"""
        headers = auth_headers(token)
        template_data = {
            "name": "测试任务模板",
        ...
        response = await async_client.post("/api/v1/tasks/templates",
    ...
    async def test_get_task_dependencies(self, async_client: AsyncClient, auth_headers, token):
        """测试获取任务依赖"""
        headers = auth_headers(token)
        task_id = 1
        
        response = await async_client.get(f"/api/v1/tasks/{task_id}/dependencies",
                                        headers=headers)
    ...
    async def test_post_task_dependency(self, async_client: AsyncClient, auth_headers, token):
        """测试创建任务依赖"""
        headers = auth_headers(token)
        task_id = 1
        dependency_data = {
        ...
        response = await async_client.post(f"/api/v1/tasks/{task_id}/dependencies",
                                         json=dependency_data, headers=headers)
...
class TestMemberProfileAndSettingsAPI:
    ...
    async def test_get_member_profile(self, async_client: AsyncClient, auth_headers, token):
        """测试获取成员资料"""
        headers = auth_headers(token)
        member_id = 1
        params = {
        ...
        response = await async_client.get(f"/api/v1/members/{member_id}/profile",
                                        params=params, headers=headers)
    ...
    async def test_update_member_settings(self, async_client: AsyncClient, auth_headers, token):
        """测试更新成员设置"""
        headers = auth_headers(token)
        member_id = 1
        settings_data = {
        ...
        response = await async_client.put(f"/api/v1/members/{member_id}/settings",
    ...
    async def test_get_member_activity(self, async_client: AsyncClient, auth_headers, token):
        """测试获取成员活动记录"""
        headers = auth_headers(token)
        member_id = 1
        params = {
        ...
        response = await async_client.get(f"/api/v1/members/{member_id}/activity",
                                        params=params, headers=headers)
...
class TestSystemHealthAndMonitoringAPI:
    ...
    async def test_get_system_health(self, async_client: AsyncClient, auth_headers, token):
        """测试获取系统健康状态"""
        headers = auth_headers(token)
        params = {
    ...
    async def test_get_system_metrics(self, async_client: AsyncClient, auth_headers, token):
        """测试获取系统指标"""
        headers = auth_headers(token)
        params = {
    ...
    async def test_post_system_maintenance(self, async_client: AsyncClient, auth_headers, token):
        """测试系统维护模式"""
        headers = auth_headers(token)
        maintenance_data = {
            "enable": True,
        ...
        response = await async_client.post("/api/v1/system/maintenance",
...
class TestAdvancedReportingAPI:
    ...
    async def test_get_custom_reports(self, async_client: AsyncClient, auth_headers, token):
        """测试获取自定义报表"""
        headers = auth_headers(token)
        params = {
            "report_type": "custom",
        ...
        response = await async_client.get("/api/v1/reports/custom",
                                        params=params, headers=headers)
    ...
    async def test_create_custom_report(self, async_client: AsyncClient, auth_headers, token):
        """测试创建自定义报表"""
        headers = auth_headers(token)
        report_data = {
            "name": "自定义考勤报表",
        ...
        response = await async_client.post("/api/v1/reports/custom",
    ...
    async def test_generate_report_preview(self, async_client: AsyncClient, auth_headers, token):
        """测试生成报表预览"""
        headers = auth_headers(token)
        report_id = 1
        params = {
        ...
        response = await async_client.get(f"/api/v1/reports/{report_id}/preview",
                                        params=params, headers=headers)
