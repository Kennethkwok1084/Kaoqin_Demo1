...
class TestAPIPerformance:
    ...
    async def test_tasks_list_performance(
        ...
        assert benchmark_result['mean'] < 0.5, f"API took {benchmark_result['mean']:.3f}s, should be < 0.5s"
    ...
    async def test_work_time_detail_performance(
        ...
        # Performance assertions
        benchmark_result = benchmark.stats
        assert benchmark_result['mean'] < 0.2, f"API took {benchmark_result['mean']:.3f}s, should be < 0.2s"
    ...
    async def test_field_mapping_performance(
        ...
        # Performance assertions
        benchmark_result = benchmark.stats
        assert benchmark_result['mean'] < 0.1, f"API took {benchmark_result['mean']:.3f}s, should be < 0.1s"
    ...
    async def test_concurrent_api_performance(
        ...
        # Performance assertions
        benchmark_result = benchmark.stats
        assert benchmark_result['mean'] < 2.0, f"Concurrent requests took {benchmark_result['mean']:.3f}s, should be < 2s"
