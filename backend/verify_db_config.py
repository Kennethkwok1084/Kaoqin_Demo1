...
async def main():
    ...
    sqlite_working = any(r["connection_success"] and "sqlite" in r["url"].lower() for r in results)
    postgres_working = any(r["connection_success"] and "postgresql" in r["url"].lower() for r in results)
