...
async def create_members_table_minimal():
    ...
    try:
        ...
        """, 'testuser', 'Test User', 'STU12345', '13800138000', 'IT Department', '2021 Class', 
             '$2b$12$7DKis8BX0BY8vqjtylV46./D2LlSwWdV0XADOPWeyWkZPIlewARyS', 'MEMBER', True, True)
        print("[OK] Inserted test user")
        
        # 验证数据
        user = await conn.fetchrow('SELECT username, name, student_id FROM members WHERE student_id = $1', 'STU12345')
