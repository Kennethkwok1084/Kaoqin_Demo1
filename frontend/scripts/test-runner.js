...
class TestRunner {
  ...
  async runUnitTests() {
    ...
    try {
      const result = await this.runCommand('test:unit:coverage', { silent: true });
  ...
  async runComponentTests() {
    ...
    try {
      const result = await this.runCommand('test:component --coverage', { silent: true });
  ...
  async generateCoverageReport() {
    ...
    try {
      const unitCoverage = this.readCoverageFile('coverage/coverage-summary.json');
      const componentCoverage = this.readCoverageFile('tests/coverage/coverage-summary.json');
  ...
  generateHTMLReport() {
    const reportPath = path.join(process.cwd(), 'tests/reports/test-report.html');
