...
export function getTaskPriorityConfig(priority: any) {
  if (
    ...
    priority in TASK_PRIORITY_CONFIG
  ) {
...
export function isValidTaskType(
  type: any
): type is keyof typeof TASK_TYPE_CONFIG {
...
export function isValidTaskPriority(
  priority: any
): priority is keyof typeof TASK_PRIORITY_CONFIG {
...
export function isValidTaskStatus(
  status: any
): status is keyof typeof TASK_STATUS_CONFIG {
